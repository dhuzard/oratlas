...
test.describe("Community review & discussion", () => {
  test("shows seeded comments and the threaded exchange to anonymous readers", async ({ page }) => {
    await page.goto(REVIEW);
    const section = page.locator("#community-review");
    await expect(section.getByRole("heading", { name: /Community review/ })).toBeVisible();
