  ...
  return (
    <article>
      <div className="btn-row">
        <Badge tone="warning">AI-written synthesis</Badge>
        <StatusPill status="editor-accepted" />
      </div>
      <h1>{synthesis.title}</h1>
      <p className="lead">{synthesis.abstract}</p>
      <Notice tone="warning" title="AI-generated, editor-approved">
        This synthesis was generated by {synthesis.provenance.pipelineSoftware.displayName} and
