...
CREATE TABLE "KnowledgeNodeVersion" (
    ...
    "sourcePublicationClaimOccurrenceId" TEXT,
    "sourceSubmissionId" TEXT,
    "inspectionCaptureId" TEXT,
    "capturePayloadHash" TEXT,
    "title" TEXT,
...
CREATE TABLE "VerificationProtocol" (
    "id" TEXT NOT NULL,
    "authorityVerifierId" TEXT NOT NULL,
    "seriesKey" TEXT NOT NULL,
    "protocolVersion" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    ...
    "supportedSubjectTypesJson" TEXT NOT NULL,
...
CREATE TABLE "VerifierCredential" (
    ...
    CONSTRAINT "VerifierCredential_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "VerificationRun" (
    ...
    "publicationClaimOccurrenceId" TEXT,
    "knowledgeNodeVersionId" TEXT,
    "claimedVerifierId" TEXT,
    "status" TEXT NOT NULL DEFAULT 'requested',
    "inputProfile" TEXT NOT NULL,
    "inputProfileVersion" TEXT NOT NULL,
    "inputSchemaVersion" TEXT NOT NULL,
    "inputJson" TEXT NOT NULL,
    "inputSha256" TEXT NOT NULL,
    "inputCapturedAt" TIMESTAMP(3) NOT NULL,
    "idempotencyKey" TEXT NOT NULL,
    ...
    "terminalReason" TEXT,
    "leaseTokenHash" TEXT,
    "leaseIssuedAt" TIMESTAMP(3),
    "leaseExpiresAt" TIMESTAMP(3),
    "leaseGeneration" INTEGER NOT NULL DEFAULT 0,
    "agentRunId" TEXT,
    "executionPassportId" TEXT,
    "replicationBriefId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "VerificationArtifact" (
    ...
    "submittedByVerifierId" TEXT NOT NULL,
...
CREATE TABLE "VerificationFindingArtifact" (
    "verificationFindingId" TEXT NOT NULL,
    "verificationArtifactId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "VerificationProtocol_supersedesProtocolId_key" ON "VerificationProtocol"("supersedesProtocolId");

-- CreateIndex
CREATE INDEX "VerificationProtocol_status_verificationType_idx" ON "VerificationProtocol"("status", "verificationType");

-- CreateIndex
CREATE UNIQUE INDEX "VerificationProtocol_authorityVerifierId_seriesKey_protocol_key" ON "VerificationProtocol"("authorityVerifierId", "seriesKey", "protocolVersion");
...
-- CreateIndex
CREATE INDEX "VerifierCredential_verifierId_revokedAt_idx" ON "VerifierCredential"("verifierId", "revokedAt");

-- CreateIndex
CREATE UNIQUE INDEX "VerificationRun_idempotencyKey_key" ON "VerificationRun"("idempotencyKey");

-- CreateIndex
CREATE INDEX "VerificationRun_publicationVersionId_createdAt_idx" ON "VerificationRun"("publicationVersionId", "createdAt");

-- CreateIndex
CREATE INDEX "VerificationRun_publicationClaimOccurrenceId_createdAt_idx" ON "VerificationRun"("publicationClaimOccurrenceId", "createdAt");

-- CreateIndex
CREATE INDEX "VerificationRun_knowledgeNodeVersionId_createdAt_idx" ON "VerificationRun"("knowledgeNodeVersionId", "createdAt");

-- CreateIndex
CREATE INDEX "VerificationRun_protocolId_status_idx" ON "VerificationRun"("protocolId", "status");

-- CreateIndex
CREATE INDEX "VerificationRun_status_leaseExpiresAt_idx" ON "VerificationRun"("status", "leaseExpiresAt");

-- CreateIndex
CREATE INDEX "VerificationArtifact_verificationRunId_status_idx" ON "VerificationArtifact"("verificationRunId", "status");

-- CreateIndex
CREATE INDEX "VerificationArtifact_sha256_idx" ON "VerificationArtifact"("sha256");

-- CreateIndex
CREATE UNIQUE INDEX "VerificationArtifact_verificationRunId_artifactKey_key" ON "VerificationArtifact"("verificationRunId", "artifactKey");

-- CreateIndex
CREATE UNIQUE INDEX "VerificationFinding_supersedesFindingId_key" ON "VerificationFinding"("supersedesFindingId");

-- CreateIndex
CREATE INDEX "VerificationFinding_verificationRunId_status_idx" ON "VerificationFinding"("verificationRunId", "status");

-- CreateIndex
CREATE INDEX "VerificationFinding_findingType_status_idx" ON "VerificationFinding"("findingType", "status");

-- CreateIndex
CREATE UNIQUE INDEX "VerificationFinding_verificationRunId_findingKey_key" ON "VerificationFinding"("verificationRunId", "findingKey");

-- CreateIndex
CREATE INDEX "VerificationFindingArtifact_verificationArtifactId_idx" ON "VerificationFindingArtifact"("verificationArtifactId");

-- CreateIndex
CREATE INDEX "VerificationRunLifecycleEvent_verificationRunId_createdAt_idx" ON "VerificationRunLifecycleEvent"("verificationRunId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "Verifier" ADD CONSTRAINT "Verifier_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationProtocol" ADD CONSTRAINT "VerificationProtocol_authorityVerifierId_fkey" FOREIGN KEY ("authorityVerifierId") REFERENCES "Verifier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationProtocol" ADD CONSTRAINT "VerificationProtocol_supersedesProtocolId_fkey" FOREIGN KEY ("supersedesProtocolId") REFERENCES "VerificationProtocol"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerifierCredential" ADD CONSTRAINT "VerifierCredential_verifierId_fkey" FOREIGN KEY ("verifierId") REFERENCES "Verifier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerifierCredential" ADD CONSTRAINT "VerifierCredential_issuedById_fkey" FOREIGN KEY ("issuedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerifierCredential" ADD CONSTRAINT "VerifierCredential_revokedById_fkey" FOREIGN KEY ("revokedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_protocolId_fkey" FOREIGN KEY ("protocolId") REFERENCES "VerificationProtocol"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_publicationVersionId_fkey" FOREIGN KEY ("publicationVersionId") REFERENCES "PublicationVersion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_publicationClaimOccurrenceId_fkey" FOREIGN KEY ("publicationClaimOccurrenceId") REFERENCES "PublicationClaimOccurrence"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_knowledgeNodeVersionId_fkey" FOREIGN KEY ("knowledgeNodeVersionId") REFERENCES "KnowledgeNodeVersion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_claimedVerifierId_fkey" FOREIGN KEY ("claimedVerifierId") REFERENCES "Verifier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_requestedById_fkey" FOREIGN KEY ("requestedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_agentRunId_fkey" FOREIGN KEY ("agentRunId") REFERENCES "AgentRun"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_executionPassportId_fkey" FOREIGN KEY ("executionPassportId") REFERENCES "ExecutionPassport"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRun" ADD CONSTRAINT "VerificationRun_replicationBriefId_fkey" FOREIGN KEY ("replicationBriefId") REFERENCES "ReplicationBrief"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationArtifact" ADD CONSTRAINT "VerificationArtifact_verificationRunId_fkey" FOREIGN KEY ("verificationRunId") REFERENCES "VerificationRun"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationArtifact" ADD CONSTRAINT "VerificationArtifact_submittedByVerifierId_fkey" FOREIGN KEY ("submittedByVerifierId") REFERENCES "Verifier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationArtifactBlob" ADD CONSTRAINT "VerificationArtifactBlob_artifactId_fkey" FOREIGN KEY ("artifactId") REFERENCES "VerificationArtifact"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationFinding" ADD CONSTRAINT "VerificationFinding_verificationRunId_fkey" FOREIGN KEY ("verificationRunId") REFERENCES "VerificationRun"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationFinding" ADD CONSTRAINT "VerificationFinding_submittedByVerifierId_fkey" FOREIGN KEY ("submittedByVerifierId") REFERENCES "Verifier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationFinding" ADD CONSTRAINT "VerificationFinding_supersedesFindingId_fkey" FOREIGN KEY ("supersedesFindingId") REFERENCES "VerificationFinding"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationFindingArtifact" ADD CONSTRAINT "VerificationFindingArtifact_verificationFindingId_fkey" FOREIGN KEY ("verificationFindingId") REFERENCES "VerificationFinding"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationFindingArtifact" ADD CONSTRAINT "VerificationFindingArtifact_verificationArtifactId_fkey" FOREIGN KEY ("verificationArtifactId") REFERENCES "VerificationArtifact"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRunLifecycleEvent" ADD CONSTRAINT "VerificationRunLifecycleEvent_verificationRunId_fkey" FOREIGN KEY ("verificationRunId") REFERENCES "VerificationRun"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRunLifecycleEvent" ADD CONSTRAINT "VerificationRunLifecycleEvent_actorUserId_fkey" FOREIGN KEY ("actorUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VerificationRunLifecycleEvent" ADD CONSTRAINT "VerificationRunLifecycleEvent_actorVerifierId_fkey" FOREIGN KEY ("actorVerifierId") REFERENCES "Verifier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
DROP TRIGGER IF EXISTS "VerificationProtocol_immutable_guard" ON "VerificationProtocol";
...
DROP TRIGGER IF EXISTS "VerifierCredential_immutable_guard" ON "VerifierCredential";
...
DROP TRIGGER IF EXISTS "VerificationRun_immutable_guard" ON "VerificationRun";
...
DROP TRIGGER IF EXISTS "VerificationArtifact_immutable_guard" ON "VerificationArtifact";
...
DROP TRIGGER IF EXISTS "VerificationArtifactBlob_immutable_guard" ON "VerificationArtifactBlob";
...
DROP TRIGGER IF EXISTS "VerificationFinding_immutable_guard" ON "VerificationFinding";
...
DROP TRIGGER IF EXISTS "VerificationFindingArtifact_immutable_guard" ON "VerificationFindingArtifact";
...
DROP TRIGGER IF EXISTS "VerificationRunLifecycleEvent_immutable_guard" ON "VerificationRunLifecycleEvent";
...
DROP TRIGGER IF EXISTS "VerificationArtifact_binding_guard" ON "VerificationArtifact";
...
DROP TRIGGER IF EXISTS "VerificationFinding_binding_guard" ON "VerificationFinding";
...
DROP TRIGGER IF EXISTS "VerificationFindingArtifact_binding_guard" ON "VerificationFindingArtifact";
